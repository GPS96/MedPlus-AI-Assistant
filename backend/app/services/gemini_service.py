...
Extract all text now:"""
    ...
    def analyze_image_directly(self, image_bytes: bytes, language: str = "en"):
        try:
            ...
            if language == "de":
                prompt = """Analysieren Sie dieses Bild der medizinischen Akte und liefern Sie eine Analyse im JSON-Format mit diesen Schlüsseln:
- summary: Kurze Zusammenfassung dessen, was Sie sehen
- key_findings: Liste der wichtigen Befunde
- recommendations: Gesundheitsempfehlungen
- next_steps: Vorgeschlagene Maßnahmen
